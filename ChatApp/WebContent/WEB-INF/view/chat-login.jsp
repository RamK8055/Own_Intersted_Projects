...
<body class="body_login">
    ...
    <div class="login-container">
        <section class="login" id="login">
            <header>
                <h2>Hey, hello !</h2>
                <h4>Welcome to Next-Gen Chatting application</h4>
            </header>
            <form class="login-form" action="/ChatApp/welcome" method="post">
                <input type="text" name="username" class="login-input" placeholder="Enter you name to continue..." required autofocus />
